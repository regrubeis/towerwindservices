      ...
      language: {
        ...
        locale: {
          en: {
            ...
            barMainText: 'Este site usa cookies para garantir que você tenha a melhor experiência em nosso site.',
            closeAriaLabel: 'Fechar',
            barLinkSetting: 'Configurações de cookies',
            barBtnAcceptAll: 'Aceitar todos os cookies',
            barBtnRejectAll: 'Rejeitar todos cookies',
            modalMainTitle: 'Configurações de cookies',
            modalMainText: 'Cookies são pequenos pedaços de dados enviados de um site e armazenados no computador do usuário pelo navegador da web do usuário enquanto o usuário está navegando. Seu navegador armazena cada mensagem em um pequeno arquivo, chamado cookie. Quando você solicita outra página do servidor, seu navegador envia o cookie de volta ao servidor. Os cookies foram projetados para ser um mecanismo confiável para sites lembrarem informações ou registrarem a atividade de navegação do usuário.',
            modalBtnSave: 'Salvar configurações atuais',
            modalBtnAcceptAll: 'Aceitar todos os cookies e fechar',
            modalBtnRejectAll: 'Rejeitar todos os cookies e fechar',
            initModalBtnAgree: 'Concordo',
            initModalBtnDisagree: 'Não concordo',
            initModalBtnOptions: 'Gerenciar Opções',
